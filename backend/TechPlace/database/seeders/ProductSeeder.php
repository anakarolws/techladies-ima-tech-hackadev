...
class ProductSeeder extends Seeder
{
    ...
    {        // Produtos para Smartphone
        DB::table('products')->insert([
            ...
            'price' => 8488.89,
            'category' => 'Smartphone',
            'profile' => 'products/smartphone/01.webp',
        ]);
        DB::table('products')->insert([
            ...
            'price' => 4525.09,
            'category' => 'Smartphone',
            'profile' => 'products/smartphone/02.webp',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'price' => 3084.49,
            'category' => "Smart TV",
            'profile' => 'products/smarttv/01.webp',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'price' => 5521.35,
            'category' => "Smart TV",
            'profile' => 'products/smarttv/02.webp',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'profile' => 'products/eletronicos/01.webp',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'price' => 69.49,
            'category' => "Eletrônicos",
            'profile' => 'products/eletronicos/08.webp',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'profile' => 'products/informatica/01.webp',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'price' => 11499.00,
            'category' => "Informática",
            'profile' => 'products/informatica/02.webp',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'profile' => 'products/casainteligente/01.webp',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'price' => 289.89,
            'category' => "Casa Inteligente",
            'profile' => 'products/casainteligente/02.webp',
        ]);
    }
}
